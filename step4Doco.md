...
Some researchers may think about a lab handbook, a group instruction guide, a team wiki or a knowledge repository. 
In the IT and Computation space, the word "Documentation" is used as a place to store all information about that project. 
...
:::::::::::::::::::::::::::::: challenge
If you find you need to focus on other modules or assessments, how long would it take you to familiarise yourself again with your project?

Will you remember where all of the data is stored?

Will you remember where to find important references?
...
You may want to share it with your supervisor, or just keep it to yourself.
...
Presumably, you included a base. But did you describe it? Was it thin or thick pan? Extra wide New York style?
...
To start with, we've already talked about the following:
 ...
 - [Data Management Plans](step1Folders.html#data-management-plan) - As discussed in Step 1.
 - What and where you completed [PreRegistration](step3MethodStats.html#preregistration) of your research project - As discussed in Step 3.
 - What and where you [published your protocols](step3MethodStats.html#transparent-methodologies-and-protocols) - As discussed in Step 3
 - How you handle [missing data](step2TidyFiles.html#interview-considerations) - As discussed in Step 2
...
A standard operating procedure (SOP) is a set of step-by-step instructions to help carry out routine operations. 
...
It is substantially easier to record data analysis if you're using code scripts rather than point-and-click programs for data analysis.
If you _are_ using point and click programs, even just writing down and taking screenshots of the analysis screens is somewhere to start. 
...
You may want to create a team password manager, or even just a personal one, to track accounts and passwords. This should prevent losing account logins where data or analysis may have occurred.
